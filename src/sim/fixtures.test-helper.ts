...
export function line(): GameState {
  ...
  const state: GameState = {
    ...
    ships: {
      [pcx]: { id: pcx, name: 'P1', role: 'packet', faction: admin, jump: 1, strength: 0, damage: 0, fuel: 0, location: { kind: 'world', world: C }, commander: null, troops: { army: 0, marines: 0 }, passengers: [], havens: null, order: { kind: 'courier', route: [C, X], then: null, repeat: true, leg: 1 }, standing: { rally: null, onContact: 'never' }, mailbag: [], lastOrders: 0, log: [] },
      [pxy]: { id: pxy, name: 'P2', role: 'packet', faction: admin, jump: 1, strength: 0, damage: 0, fuel: 0, location: { kind: 'world', world: X }, commander: null, troops: { army: 0, marines: 0 }, passengers: [], havens: null, order: { kind: 'courier', route: [X, Y], then: null, repeat: true, leg: 1 }, standing: { rally: null, onContact: 'never' }, mailbag: [], lastOrders: 0, log: [] },
    },
    characters: {
