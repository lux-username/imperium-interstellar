...
describe('the transport order', () => {
  it('loads from the garrison where the order is read and reinforces a friendly world, less what did not wake', () => {
    ...
    // The master writes home from X; the letter is how Government House learns what arrived.
...
describe('landings', () => {
  ...
  it('a relief force fights it out and the world is retaken or the landing thrown back — and Government House can hear which', () => {
    const s = withTransport()
...
describe('appointments', () => {
  ...
  it('a governor loyal to Government House hands over without a fuss', () => {
    const s = withTransport()
