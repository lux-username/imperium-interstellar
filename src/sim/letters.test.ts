...
/** A warship of the Home Office's at `at`, rallying on C. */
...
describe('captains write on occasion', () => {
  it('a hull sent out and back writes a general report on making the rendezvous, covering everything since her orders', () => {
    ...
    // Her log carried the event home; the general report is not written at the capital itself, where the Home Office sees her directly.
