...
describe('events', () => {
  it('a new game has no events yet: nothing that happened before the Home Office sat down is news', () => {
    const s = newGame(7)
  ...
  it('every report the Home Office holds names its channel, and rumours and mail are separate piles', () => {
    const s = newGame(7)
