...
/**
 * The picture as of an earlier week: the same reports the desk holds now,
      ...
      <main className="panes">
        ...
        <section className="pane centre">
          <div className="scrubber">
            <label>
              <span className={past ? 'warn' : ''}>{past ? `Week ${shown.week} — what the desk now knows of it` : `Week ${view.week} — the present`}</span>
          ...
          <div className="legend">
            ...
            <span className="muted">— as the desk last heard; the badge says how long ago, a dashed ring means the word is old. Hulls where last seen:</span>{' '}
