...
| HEAD | b87c2b0 — Spec and decisions: unrest thresholds, per-port commander letters, rumour off the map, the orders dialog (branch `worktree-phase1a`, on `worktree-phase1-milestones` 2fbc8e5, on `main` aa3a898) |
