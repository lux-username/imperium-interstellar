...
4. Rolling goes through `src/sim/rng.ts` like everything else. The draws live in `src/sim/names.ts`; the syllable generator that used to name worlds and people now names only ships.
